      ...
      return weeks;
		...
		*/
		var draw = function() {
          ...
          headerGroup.append("<div class='row sin-margin'>" +"<div class='col-lg-12 col-md-12'>" + "<h2 class='mese-cand'>"+ headerMonth + "</h2>"+ "</div>"+ "</div>");
          ...
          var tableHeadGroup = $("<thead class='dnCalendar-head'></thead>");
          ...
          for (var i = 0; i < nDates; i++) {
            ...
            for (var j = 0; j < nDate; j++) {
              ...
              var fechaID = year + '-' + monthID + '-' + dateID;
            //   var fecha =  year + '-' + month + '-' + date;
              var colDate = "<td data-toggle='modal' data-target='#myModal"+fechaID+"' id='calendarClick' class='"+ colDateClass +" "+ ((showCalendarClick == true) ? 'calendarClick' : '') +"' data-date='"+ date +"' data-month='"+ month +"' data-year='"+ year +"'><div class='entry' id='"+fechaID+"' "+ colDateDataAttr +">"+ date +"</div></td>";
              
              if (minDate != null) {
                var myCurrentDate = new Date(year, month, date);
                if (minDate > myCurrentDate) {
                  colDate = "<td data-toggle='modal' data-target='#myModal"+fechaID+"' class='"+ colDateClass +"' data-date='"+ date +"' data-month='"+ month +"' data-year='"+ year +"'><div class='entry' "+ colDateDataAttr +">"+ date +"</div></td>";
                }
              } 
